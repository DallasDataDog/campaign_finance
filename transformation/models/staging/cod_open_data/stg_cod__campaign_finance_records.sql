...
SELECT 
    ...
    CASE
        ...
        WHEN UPPER(BUSINESS_NAME) = 'INDIVIDUAL' THEN UPPER(CONCAT(FIRST_NAME,' ',LAST_NAME))
        WHEN UPPER(BUSINESS_NAME) = 'PRIVATE INDIVIDUAL' THEN UPPER(CONCAT(FIRST_NAME,' ',LAST_NAME))
