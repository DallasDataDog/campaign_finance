...
CREATE OR REPLACE TABLE RAW.COD_CAMPAIGN_FINANCE.ALL_REPORT_RECORDS (
...
COPY INTO RAW.COD_CAMPAIGN_FINANCE.ALL_REPORT_RECORDS
FROM
    (
    SELECT
        $1,
        ...
        FROM @RAW.COD_CAMPAIGN_FINANCE.RAW_FILES
    )
FILE_FORMAT = RAW.COD_CAMPAIGN_FINANCE.CAMPAIGN_FINANCE_CSV;